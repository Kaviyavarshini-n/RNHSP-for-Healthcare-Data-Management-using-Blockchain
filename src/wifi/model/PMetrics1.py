...
def PerformanceMetrics():
    ...
    def Data_Storage_Efficiency():
        ...
        plt.bar(indices, a_c_t,  color='#808080', edgecolor='#008000', linewidth=2, label='Scenario -1 (Raft Net Health Sync Protocol (RNHSP))')
    ...
    def Latency():
        ...
        plt.rcParams['font.family'] = 'Gurajada'
        plt.rcParams['font.size'] = 14
        plt.plot(indices, c_r, color='#000080', marker='s',markersize = 7,mfc= '#800000', mec='#800000', linestyle='--', linewidth=2, label='Scenario -1 (Raft Net Health Sync Protocol (RNHSP))')
    ...
    def Confidentiality():
        ...
        plt.rcParams['font.family'] = 'Gurajada'
        plt.rcParams['font.size'] = 14
        plt.plot(indices, a_c_c, color='#00FFFF', marker='s', mfc='#000000', mec='#000000', linestyle='-.', linewidth=2, label='Scenario -1 (Raft Net Health Sync Protocol (RNHSP))')
    ...
    def Throughput():
        ...
        plt.rcParams['font.family'] = 'Gurajada'
        plt.rcParams['font.size'] = 14
        plt.bar(indices, t_p,  color='#00FF00', edgecolor='#808000', linewidth=2, label='Scenario -1 (Raft Net Health Sync Protocol (RNHSP))')
    ...
    def Data_Integrity():
        ...
        plt.rcParams['font.family'] = 'Gurajada'
        plt.rcParams['font.size'] = 14
        plt.plot(indices, t_p_t, color='#FF00FF', marker='D',markersize = 7,mfc= '#00FF00', mec='#00FF00', linestyle='--', linewidth=2, label='Scenario -1 (Raft Net Health Sync Protocol (RNHSP))')
