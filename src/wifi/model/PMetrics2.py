...
def PerformanceMetrics():
    ...
    def Data_Storage_Efficiency():
        ...
        plt.bar(indices, a_c_t,  color='#87CEEB', edgecolor='#000000', linewidth=2, label='Scenario -2 (Paxos protocol)')
    ...
    def Latency():
        ...
        plt.rcParams['font.family'] = 'Gurajada'
        plt.rcParams['font.size'] = 14
        plt.plot(indices, c_r, color='#FFD700', marker='s',markersize = 7,mfc= '#4169E1', mec='#4169E1', linestyle='--', linewidth=2, label='Scenario -2 (Paxos protocol)')
    ...
    def Confidentiality():
        ...
        plt.rcParams['font.family'] = 'Gurajada'
        plt.rcParams['font.size'] = 14
        plt.plot(indices, a_c_c, color='#FF00FF', marker='s', mfc='#FFD700', mec='#FFD700', linestyle='-.', linewidth=2, label='Scenario -2 (Paxos protocol)')
    ...
    def Throughput():
        ...
        plt.rcParams['font.family'] = 'Gurajada'
        plt.rcParams['font.size'] = 14
        plt.bar(indices, t_p,  color='brown', edgecolor='#000080', linewidth=2, label='Scenario -2 (Paxos protocol)')
    ...
    def Data_Integrity():
        ...
        plt.rcParams['font.family'] = 'Gurajada'
        plt.rcParams['font.size'] = 14
        plt.plot(indices, t_p_t, color='#002366', marker='D',markersize = 7,mfc= '#800000', mec='#800000', linestyle='--', linewidth=2, label='Scenario -2 (Paxos protocol)')
