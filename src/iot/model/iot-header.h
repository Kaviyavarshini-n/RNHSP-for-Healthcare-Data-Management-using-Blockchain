 ...
 */
std::ostream & operator<< (std::ostream & os, IoTHc1 const &header);

/**
 * \ingroup iot
 * \brief 6LoWPAN FRAG1 header - see \RFC{4944}.
 */
class IoTFrag1 : public Header
{
public:
  IoTFrag1 (void);
 ...
 * \returns The reference to the output stream.
 */
std::ostream & operator<< (std::ostream & os, IoTFrag1 const & header);

/**
 * \ingroup iot
 * \brief 6LoWPAN FRAGN header - see \RFC{4944}.
 */
class IoTFragN : public Header
{
public:
  IoTFragN (void);
 ...
 * \returns The reference to the output stream.
 */
std::ostream & operator<< (std::ostream & os, IoTFragN const &header);

/**
 * \ingroup iot
 * \brief 6LoWPAN IPv6 uncompressed header - see \RFC{4944}.
 */
class IoTIpv6 : public Header
{
public:
  IoTIpv6 (void);
 ...
 * \returns The reference to the output stream.
 */
std::ostream & operator<< (std::ostream & os, IoTIpv6 const & header);
 ...
 * \returns The reference to the output stream.
 */
std::ostream & operator<< (std::ostream & os, IoTIphc const &header);
...
* \brief   LOWPAN_NHC Extension Header Encoding - see \RFC{6282}.
  ...
  \endverbatim
*/
class IoTNhcExtension : public Header
{
public:
  /**
   ...
   * \return The NhcDispatch type.
   */
  virtual IoTDispatch::NhcDispatch_e GetNhcDispatchType (void) const;
 ...
 * \returns The reference to the output stream.
 */
std::ostream & operator<< (std::ostream & os, IoTNhcExtension const &header);
...
* \brief   UDP LOWPAN_NHC Extension Header Encoding - see \RFC{6282}.
  ...
  \endverbatim
*/
class IoTUdpNhcExtension : public Header
{
public:
  /**
   *  \brief Ports:
 ...
 * \returns The reference to the output stream.
 */
std::ostream & operator<< (std::ostream & os, IoTUdpNhcExtension const &header);

/**
 * \ingroup iot
 * \brief 6LoWPAN BC0 header - see \RFC{4944}.
 */
class IoTBc0 : public Header
{
public:
  IoTBc0 (void);
 ...
 * \returns The reference to the output stream.
 */
std::ostream & operator<< (std::ostream & os, IoTBc0 const &header);

/**
 * \ingroup iot
 * \brief 6LoWPAN Mesh header - see \RFC{4944}.
 */
class IoTMesh : public Header
{
public:
  IoTMesh (void);
 ...
 * \returns The reference to the output stream.
 */
std::ostream & operator<< (std::ostream & os, IoTMesh const &header);
