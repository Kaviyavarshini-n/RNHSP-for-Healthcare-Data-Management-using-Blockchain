...
/**
 * \ingroup iot
 * \defgroup iot-test 6LoWPAN module tests
 */
 ...
 */
class IotIphcStatefulImplTest : public TestCase
{
  /**
  ...
  /**
   * Promiscuous receive from a IoTNetDevice.
   * \param device a pointer to the net device which is calling this function
   * \param packet the packet received
   * \param protocol the 16 bit protocol number associated with this packet.
   * \param source the address of the sender
   ...
   * \returns true.
   */
  bool PromiscReceiveFromIoTDevice (Ptr<NetDevice> device, Ptr<const Packet> packet, uint16_t protocol,
                                          Address const &source, Address const &destination, NetDevice::PacketType packetType);
  ...
  NetDeviceContainer m_sixDevices; //!< IoTNetDevice container

public:
  virtual void DoRun (void);
  IotIphcStatefulImplTest ();
};

IotIphcStatefulImplTest::IotIphcStatefulImplTest ()
  : TestCase ("Iot IPHC stateful implementation")
{
}

bool
IotIphcStatefulImplTest::ReceiveFromMockDevice (Ptr<NetDevice> device, Ptr<const Packet> packet, uint16_t protocol,
                                                      Address const &source, Address const &destination, NetDevice::PacketType packetType)
{
  Data incomingPkt;
...
bool
IotIphcStatefulImplTest::PromiscReceiveFromIoTDevice (Ptr<NetDevice> device, Ptr<const Packet> packet, uint16_t protocol,
                                                                  Address const &source, Address const &destination, NetDevice::PacketType packetType)
{
  Data incomingPkt;
  incomingPkt.packet = packet->Copy ();
...
void
IotIphcStatefulImplTest::SendOnePacket (Ptr<NetDevice> device, Ipv6Address from, Ipv6Address to)
{
...
void
IotIphcStatefulImplTest::DoRun (void)
{
  NodeContainer nodes;
  nodes.Create(2);
  ...
  mockNetDevice0->SetSendCallback ( MakeCallback (&IotIphcStatefulImplTest::ReceiveFromMockDevice, this) );
  ...
  IoTHelper iot;
  m_sixDevices = iot.Install (m_mockDevices);
  m_sixDevices.Get (1)->SetPromiscReceiveCallback ( MakeCallback (&IotIphcStatefulImplTest::PromiscReceiveFromIoTDevice, this) );
  ...
  iot.AddContext (m_sixDevices, 0, Ipv6Prefix ("2001:2::", 64), Time (Minutes (30)));
  iot.AddContext (m_sixDevices, 1, Ipv6Prefix ("2001:1::", 64), Time (Minutes (30)));
  ...
  Simulator::Schedule (Seconds (1), &IotIphcStatefulImplTest::SendOnePacket, this, m_sixDevices.Get (0),
                       Ipv6Address::GetAny (),
                       dstElided);

  Simulator::Schedule (Seconds (2), &IotIphcStatefulImplTest::SendOnePacket, this, m_sixDevices.Get (0),
                       Ipv6Address ("2001:2::f00d:f00d:cafe:cafe"),
                       Ipv6Address ("2001:1::0000:00ff:fe00:cafe"));

  Simulator::Schedule (Seconds (3), &IotIphcStatefulImplTest::SendOnePacket, this, m_sixDevices.Get (0),
                       Ipv6Address ("2001:1::0000:00ff:fe00:cafe"),
                       Ipv6Address ("2001:1::f00d:f00d:cafe:cafe"));

  Simulator::Schedule (Seconds (4), &IotIphcStatefulImplTest::SendOnePacket, this, m_sixDevices.Get (0),
                       srcElided,
                       Ipv6Address ("2001:1::f00d:f00d:cafe:cafe"));
  ...
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSam (), IoTIphc::HC_INLINE, "SAM should be HC_INLINE, it is not");
  ...
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDam (), IoTIphc::HC_COMPR_0, "DAM should be HC_COMPR_0, it is not");
  ...
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSac (), true, "SAC should be true, is false");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSam (), IoTIphc::HC_COMPR_64, "SAM should be HC_COMPR_64, it is not");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetM (), false, "M should be false, is true");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDac (), true, "DAC should be true, is false");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSrcContextId (), 0, "Src context should be 0, it is not");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDstContextId (), 1, "Dst context should be 1, it is not");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDam (), IoTIphc::HC_COMPR_16, "DAM should be HC_COMPR_16, it is not");
  ...
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetCid (), true, "CID should be true, is false");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSac (), true, "SAC should be true, is false");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSam (), IoTIphc::HC_COMPR_16, "SAM should be HC_COMPR_16, it is not");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetM (), false, "M should be false, is true");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDac (), true, "DAC should be true, is false");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSrcContextId (), 1, "Src context should be 1, it is not");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDstContextId (), 1, "Dst context should be 1, it is not");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDam (), IoTIphc::HC_COMPR_64, "DAM should be HC_COMPR_64, it is not");
  ...
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetCid (), true, "CID should be true, is false");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSac (), true, "SAC should be true, is false");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSam (), IoTIphc::HC_COMPR_0, "SAM should be HC_COMPR_0, it is not");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetM (), false, "M should be false, is true");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDac (), true, "DAC should be true, is false");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetSrcContextId (), 0, "Src context should be 0, it is not");
  NS_TEST_EXPECT_MSG_EQ (iphcHdr.GetDstContextId (), 1, "Dst context should be 1, it is not");
 ...
 */
class IotIphcStatefulTestSuite : public TestSuite
{
public:
  IotIphcStatefulTestSuite ();
private:
};

IotIphcStatefulTestSuite::IotIphcStatefulTestSuite ()
  : TestSuite ("iot-iphc-stateful", UNIT)
{
  AddTestCase (new IotIphcStatefulImplTest (), TestCase::QUICK);
}

static IotIphcStatefulTestSuite g_iotIphcStatefulTestSuite; //!< Static variable for test initialization
