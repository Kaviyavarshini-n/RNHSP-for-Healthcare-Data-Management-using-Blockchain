 ...
 */
class IotHc1ImplTest : public TestCase
{
...
IotHc1ImplTest::IotHc1ImplTest ()
  : TestCase ("Iot implementation")
{
}

void IotHc1ImplTest::ReceivePacket (Ptr<Socket> socket, Ptr<Packet> packet, const Address &from)
{
  m_receivedPacket = packet;
}

void IotHc1ImplTest::ReceivePkt (Ptr<Socket> socket)
{
...
void
IotHc1ImplTest::DoSendData (Ptr<Socket> socket, std::string to)
{
...
void
IotHc1ImplTest::SendData (Ptr<Socket> socket, std::string to)
{
  m_receivedPacket = Create<Packet> ();
  Simulator::ScheduleWithContext (socket->GetNode ()->GetId (), Seconds (0),
                                  &IotHc1ImplTest::DoSendData, this, socket, to);
  Simulator::Run ();
}

void
IotHc1ImplTest::DoRun (void)
{
  // Create topology
  ...
  rxSocket->SetRecvCallback (MakeCallback (&IotHc1ImplTest::ReceivePkt, this));
 ...
 */
class IotHc1TestSuite : public TestSuite
{
public:
  IotHc1TestSuite ();
private:
...
IotHc1TestSuite::IotHc1TestSuite ()
  : TestSuite ("iot-hc1", UNIT)
{
  AddTestCase (new IotHc1ImplTest (), TestCase::QUICK);
}

static IotHc1TestSuite g_iotHc1TestSuite; //!< Static variable for test initialization
