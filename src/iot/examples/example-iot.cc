...
//       ================        =================
//
// - Tracing of queues and packet receptions to file "example-iot.tr"
...
NS_LOG_COMPONENT_DEFINE ("Exampleiot");
...
int main (int argc, char** argv)
{
  ...
  if (verbose)
    {
      LogComponentEnable ("IoTNetDevice", LOG_LEVEL_ALL);
  ...
  NetDeviceContainer six1 = iot.Install (d1);
  ...
  csma.EnableAsciiAll (ascii.CreateFileStream ("example-iot.tr"));
  csma.EnablePcapAll (std::string ("example-iot"), true);
