...
int main (int argc, char** argv)
{
  ...
  cmd.AddValue ("enable-iot-loginfo", "enable iot LOG_LEVEL_INFO (used for tests)", enableLSixlowLogLevelInfo);
  cmd.Parse (argc, argv);
  ...
  IoTHelper iot;
  NetDeviceContainer devices = iot.Install (lrwpanDevices); 
