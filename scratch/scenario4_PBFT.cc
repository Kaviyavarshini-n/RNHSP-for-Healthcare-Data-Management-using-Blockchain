...
{
    std::cout << "\n\n==================================================================================================================================================\n";
    std::cout << "\n\t\t\t\t  (+) Perform Access Control and Data Sharing using PBFT Protocol\n";
    std::cout << "\n==================================================================================================================================================\n\n";
    sleep(5);
    ACCPROTOCOLS obj;
    obj.pbft();
...
int main(int argc, char *argv[])
{
    ...
    sleep(2);
    std::cout << "\n==================================================================================================================================================\n\n";
    std::cout << " \t\t\t\t\t\t Scenario -4 (PBFT protocol)\n";
    std::cout << "\n==================================================================================================================================================\n\n";
    sleep(5);
    std::cout << "\n\n==================================================================================================================================================\n";
    ...
    std::vector<double> tpt = gen_values(75, 92, numBlocks - 1);
    double tptValue = 80.0;
    tpt.push_back(tptValue);
    YansWifiChannelHelper wifiChannel;
    wifiChannel.SetPropagationDelay("ns3::ConstantSpeedPropagationDelayModel");
    std::vector<double> act = gen_values(0.7, 3.5, numTransactions-1);
    double actValue = 1.0;
    ...
    std::vector<double> cr = gen_values(40, 110, numTransactions - 1);
    double crValue = 25.0;
    ...
    std::vector<double> tp = gen_values(50, 250, numTransactions - 1);
    double tpValue = 45.0;
    ...
    std::vector<double> acc = gen_values(60.0, 90.0, numTransactions - 1);
  ...
  Simulator::Schedule(Seconds(0.3), &GenerateTraffic, source, packetSize, noofpkts, interPacketInterval);
   ...
   Simulator::Schedule(Seconds(12.3), &PktTrans4, User_Nodes, Blockchain_Node);
    ...
    pAnim = new AnimationInterface("scenario4_PBFT.xml");
    pAnim->SetBackgroundImage("/home/research/ns-allinone-3.35/netanim-3.108/img/bg4.png", -1000, -1000, 4.0, 4.0, 1.0);
    uint32_t UserImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/user4.png");
    uint32_t BaseStationImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/base4.png");
    uint32_t BlockchainImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/block4.png");
    for (uint32_t i = 0; i < User_Nodes.GetN(); i++)
    {
