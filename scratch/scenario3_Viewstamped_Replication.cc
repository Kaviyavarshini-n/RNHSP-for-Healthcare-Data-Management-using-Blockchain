...
**                                                                                                                    																																											  **
**                                                                                ======== Scenario -3 (Viewstamped Replication)========                                                 																			 
**                                                                                                                    																																											  **
*******************************************************************************************************************************************************************************************************************************************
*/
#include <cmath>
...
{
    std::cout << "\n\n==================================================================================================================================================\n";
    std::cout << "\n\t\t\t\t  (+) Perform Access Control and Data Sharing using Viewstamped Replication Protocol\n";
    std::cout << "\n==================================================================================================================================================\n\n";
    sleep(5);
    ACCPROTOCOLS obj;
    obj.viewstamp();
...
int main(int argc, char *argv[])
{
    ...
    sleep(2);
    std::cout << "\n==================================================================================================================================================\n\n";
    std::cout << "  \t\t\t\t\t Scenario -3 (Viewstamped Replication)\n";
    std::cout << "\n==================================================================================================================================================\n\n";
    sleep(5);
    std::cout << "\n\n==================================================================================================================================================\n";
    ...
    std::vector<double> tpt = gen_values(70, 92, numBlocks - 1);
    double tptValue = 80.0;
    tpt.push_back(tptValue);
    YansWifiChannelHelper wifiChannel;
    wifiChannel.SetPropagationDelay("ns3::ConstantSpeedPropagationDelayModel");
    std::vector<double> act = gen_values(0.45, 4.0, numTransactions-1);
    double actValue = 2.0;
    ...
    std::vector<double> cr = gen_values(20, 70, numTransactions - 1);
    double crValue = 25.0;
    ...
    std::vector<double> tp = gen_values(100, 300, numTransactions - 1);
    double tpValue = 45.0;
    ...
    std::vector<double> acc = gen_values(65.0, 90.0, numTransactions - 1);
   ...
   Simulator::Schedule(Seconds(12.3), &PktTrans4, User_Nodes, Blockchain_Node);
    ...
    pAnim = new AnimationInterface("scenario3_Viewstamped_Replication.xml");
    pAnim->SetBackgroundImage("/home/research/ns-allinone-3.35/netanim-3.108/img/bg3.png", -1000, -1000, 4.0, 4.0, 1.0);
    uint32_t UserImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/user3.png");
    uint32_t BaseStationImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/base3.png");
    uint32_t BlockchainImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/block3.png");
    for (uint32_t i = 0; i < User_Nodes.GetN(); i++)
    {
