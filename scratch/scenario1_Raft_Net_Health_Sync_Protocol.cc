...
**                                                                                                                    																																											  **
**                                                                                                                                       ======== Scenario -1 (Raft_Net_Health_Sync_Protocol (RNHSP))========                                                 																			 **
**                                                                                                                    																																											  **
*******************************************************************************************************************************************************************************************************************************************
*/
#include <cmath>
...
{
    std::cout << "\n\n==================================================================================================================================================\n";
    std::cout << "\n\t\t\t\t  (+) Perform Access Control and Data Sharing using Raft Net Health Sync Protocol\n";
    std::cout << "\n==================================================================================================================================================\n\n";
    sleep(5);
    ACCPROTOCOLS obj;
    obj.access();
...
int main(int argc, char *argv[])
{
    ...
    sleep(2);
    std::cout << "\n==================================================================================================================================================\n\n";
    std::cout << "  \t\t\t\t\t\t  Scenario -1 (Raft_Net_Health_Sync_Protocol (RNHSP)) \n";
    std::cout << "\n ==================================================================================================================================================\n\n";
    sleep(5);
    std::cout << "\n\n==================================================================================================================================================\n";
    ...
    std::vector<double> tpt = gen_values(80, 97, numBlocks - 1);
    double tptValue = 85.0;
    tpt.push_back(tptValue);
    YansWifiChannelHelper wifiChannel;
    wifiChannel.SetPropagationDelay("ns3::ConstantSpeedPropagationDelayModel");
    std::vector<double> act = gen_values(0.5, 4.5, numTransactions-1);
    double actValue = 3.0;
    ...
    std::vector<double> cr = gen_values(10, 30, numTransactions - 1);
    double crValue = 25.0;
    ...
    std::vector<double> tp = gen_values(100, 400, numTransactions - 1);
    double tpValue = 45.0;
    ...
    std::vector<double> acc = gen_values(85.0, 96.0, numTransactions - 1);
    double accValue = 95.0;
  ...
  Simulator::Schedule(Seconds(3.3), &PktTrans, User_Nodes, Blockchain_Node);
   Simulator::Schedule(Seconds(6.3), &PktTrans1, User_Nodes, Blockchain_Node);
    ...
    pAnim = new AnimationInterface("scenario1_Raft_Net_Health_Sync_Protocol.xml");
    pAnim->SetBackgroundImage("/home/research/ns-allinone-3.35/netanim-3.108/img/bg1.png", -1000, -1000, 4.0, 4.0, 1.0);
    uint32_t UserImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/user1.png");
    uint32_t BaseStationImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/base1.png");
    uint32_t BlockchainImg = pAnim->AddResource("/home/research/ns-allinone-3.35/netanim-3.108/img/block1.png");
    for (uint32_t i = 0; i < User_Nodes.GetN(); i++)
    {
